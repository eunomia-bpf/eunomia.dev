...
Title: eBPF 教程：检查 exec 后真正安装的可执行镜像
Source path: docs/tutorials/54-exec-image-inspector/README.zh.md
Source URL for ledger: https://eunomia.dev/zh/tutorials/54-exec-image-inspector/
Project source: https://github.com/eunomia-bpf/bpf-developer-tutorial/tree/main/src/54-exec-image-inspector
Category: 后端
Tags: Linux, eBPF, 开源 (draft target); public page visibly renders Linux and 开源
Media: preserve the single public exec-image-flow.png figure from the source
Body policy: source H1 is carried by the Juejin title field; all remaining source content is unchanged
Published URL: https://juejin.cn/post/7664864449153613824
QA state: confirmed on the visible profile list and public article page; exact title, body, 10 code blocks, one 6-row table, the loaded 1700x1057 image, and 11 outbound links verified
-->
...
![exec 镜像检查器数据流](https://raw.githubusercontent.com/eunomia-bpf/bpf-developer-tutorial/main/src/54-exec-image-inspector/exec-image-flow.png)
