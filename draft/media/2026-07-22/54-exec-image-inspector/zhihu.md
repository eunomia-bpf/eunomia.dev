...
Published URL: https://zhuanlan.zhihu.com/p/2063162298781398619
Project source: https://github.com/eunomia-bpf/bpf-developer-tutorial/tree/main/src/54-exec-image-inspector
Media: the local exec-image-flow.png was uploaded after the remote import failed
Body policy: source H1 is carried by the Zhihu title field; all remaining source content is unchanged
QA state: updated in place on 2026-07-22; the public page shows the exact source title, 15 section headings, 8 rendered code blocks, one table, one loaded 960x418 image, and the current system-wide lifecycle text
-->
