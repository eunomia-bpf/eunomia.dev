...
Source: docs/blog/posts/cpu-noise-gpu-inference.zh.md
Canonical: https://eunomia.dev/zh/blog/2026/05/24/measuring-cpu-noise-in-gpu-inference-with-ebpf/
Title: CPU 噪声会拖慢 GPU 推理吗：用 eBPF 定量测量调度器与 IRQ 影响
Category: 人工智能
Tags: Linux, 人工智能, 性能优化
Summary: 通过 eBPF 追踪 CUDA kernel launch、调度器上下文切换和 IRQ，定量分析 CPU 噪声何时会拖慢 GPU LLM 推理，以及 CPU 绑核能恢复多少吞吐。
Media: no inline images in the canonical source
Body: canonical Chinese source with YAML front matter, repeated H1, and the excerpt marker removed mechanically; no substantive changes
Staged URL: https://juejin.cn/spost/7679000152964153353
Public URL: https://juejin.cn/post/7679000152964153353
QA: exact-title and same-source duplicate check passed across all five visible authored-profile pages; visible editor preview and full-scroll public-page QA confirmed 22 body headings, 12 code blocks, 17 tables, 6 source links, 0 inline images, the intended tags, and no failure or review marker on 2026-08-28
-->
