...
Source: docs/tutorials/49-hid/README.zh.md
Canonical: https://eunomia.dev/zh/tutorials/49-hid/
Title: eBPF 教程：无需内核补丁修复故障的 HID 设备
Category: 后端
Tags: Linux, 开源, 后端
Summary: 本教程使用 UHID 创建虚拟鼠标，并通过 HID-BPF 在输入子系统处理事件前修改报告，演示如何在无需内核补丁的情况下修复轴反转、按钮映射等设备问题。
Media: no inline images in the canonical source
Body: canonical Chinese source with the repeated H1 removed and two unlabeled text fences labeled mechanically; no substantive changes
Staged URL: https://juejin.cn/spost/7680099381967798307
Public URL: https://juejin.cn/post/7680099381967798307
Review: confirmed public on 2026-08-31
QA: all five visible profile pages checked before submission; one unrelated draft, 48 published articles, zero under review, and zero rejected. Exact title, unchanged body, 14 body headings, 14 code blocks, zero tables, nine source links, zero images, Linux/开源/后端 tags, complete conclusion and final reference, and full-scroll public rendering confirmed; author list contains the public URL.
-->
