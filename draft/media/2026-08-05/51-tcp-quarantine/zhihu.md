...
Title: eBPF 教程：精准隔离已建立的 TCP 连接
Source path: docs/tutorials/51-tcp-quarantine/README.zh.md
Source URL for ledger: https://eunomia.dev/zh/tutorials/51-tcp-quarantine/
Project source: https://github.com/eunomia-bpf/bpf-developer-tutorial/tree/main/src/51-tcp-quarantine
Published URL: https://zhuanlan.zhihu.com/p/2068597605345531007
Question: TCP服务器如何处理恶意连接？ (https://www.zhihu.com/question/22254332)
Topics: TCP, ebpf
Media: source contains no inline images; use no cover unless Zhihu requires one
Formatting fixes: source H1 is carried by the Zhihu title field
Body policy: title and substantive body preserved exactly
QA state: confirmed on the public page
Public-page QA: exact title, 15 body headings, 9 code blocks, 1 table with 7 rows, 6 outbound article links, no inline images, and no failure placeholders
-->
