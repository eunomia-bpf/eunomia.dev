...
- Sample the data from hash maps and print them in human readable format with comments:
    ...
    see [examples/bpftools/mdflush.bpf.c](https://github.com/eunomia-bpf/eunomia-bpf/tree/master/examples/bpftools/runqlat/runqlat.bpf.c) for example.
...
- Automatically generate and config command line arguments for your eBPF program from the comments in your kernel code:
    ...
    see [examples/bpftools/opensnoop/opensnoop.bpf.c](https://github.com/eunomia-bpf/eunomia-bpf/tree/master/examples/bpftools/opensnoop/opensnoop.bpf.c) for example.
...
- An Observability tool
    ...
    > An prometheus and OpenTelemetry exporter for custom eBPF metrics, written in async rust: [eunomia-exporter](exporter/index.md). You can compile it or download from [release](https://github.com/eunomia-bpf/eunomia-bpf/releases/)
