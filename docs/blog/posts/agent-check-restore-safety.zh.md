...
![Action Replay 攻击流程](https://eunomia.dev/_content-assets/docs/blog/posts/imgs/acrfence/fig-sequence.png)
...
![Agent 状态和外部状态的分叉](https://eunomia.dev/_content-assets/docs/blog/posts/imgs/acrfence/fig-divergence.png)
...
![正常执行与攻击执行对比](https://eunomia.dev/_content-assets/docs/blog/posts/imgs/acrfence/fig-comparison.png)
...
- tool 名称和参数；
- 返回值或错误；
- 运行环境上下文，例如进程、网络连接、文件访问等，可通过 [AgentSight](https://github.com/eunomia-bpf/agentsight/) 这类基于 eBPF 的系统级监控补充；
- 可能被消费的凭证或授权对象。
