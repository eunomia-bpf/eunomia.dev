...
- [`pahole` v1.31 发布说明](https://github.com/acmel/dwarves/releases/tag/v1.31)
- [Linux 内核文档：BPF Type Format](https://docs.kernel.org/bpf/btf.html)
- [Linux 内核文档：`bpftool-btf`](https://docs.kernel.org/bpf/bpftool-btf.html)
- [Linux 内核文档：`sched_ext`](https://docs.kernel.org/scheduler/sched-ext.html)
- [`scx` PR：在发行版内核上运行 verifier 测试](https://github.com/sched-ext/scx/pull/3700)
- [BPF 邮件列表：最多 16 字节的聚合返回值](https://lore.kernel.org/bpf/20260808190322.1896580-1-yonghong.song@linux.dev/T/#t)
- [BPF 邮件列表：arena 缺页时遵守 `memory.max`](https://lore.kernel.org/bpf/20260808140720.293604-1-jiayuan.chen@linux.dev/T/#t)
- [BPF 邮件列表：kfunc 与 `struct_ops` 的 arena 参数](https://lore.kernel.org/bpf/178618382564.2611241.3179867674703496337.git-patchwork-notify@kernel.org/T/#t)
- [BPF 邮件列表：`tracing_multi` link 支持](https://lore.kernel.org/bpf/20260809150111.45000-1-leon.hwang@linux.dev/T/#t)
