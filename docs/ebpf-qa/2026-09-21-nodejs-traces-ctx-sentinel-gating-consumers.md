# For a Node.js service instrumented by OBI, why can't I just turn off the per-callback `async_hooks` trace-context sentinel because the service doesn't use manual spans or log enrichment?
