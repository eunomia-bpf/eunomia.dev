...
- after website deployment, open both EN and ZH routes in a real browser and verify every article image completes loading with nonzero rendered dimensions; a successful HTTP request or correct-looking Markdown path is not sufficient image QA;
