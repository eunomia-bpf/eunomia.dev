...
57 on Juejin (50/107 mapped). These raw counts include paused material,
...
one-by-one in `draft/plan/publishing-queue.zh.md`; 24 Zhihu and 28 Juejin tasks
...
a second post on the same platform that day unless it redeems a catch-up gap.
...
| Zhihu | Normal visible browser checks confirmed the fsession tutorial publication on 2026-08-14; machine ledger maps 68/107 Chinese sources | 39 configured Chinese sources remain unmatched; the visible profile was rechecked on 2026-09-23 and `/creator` still redirects to `/signin`, with no `z_c0` auth cookie, so the session is not signed in | Resume the first queued AgentCgroup task after a visible Zhihu session is signed in; recheck the title before submission |
| Juejin | 38-btf-uprobe at <https://juejin.cn/post/7689065487933833262> (2026-09-25) is confirmed public with full public-page QA, published through the visible editor using the LA 2026-09-25 normal slot with no catch-up gap redeemed, alongside 39-nginx at <https://juejin.cn/post/7689030180350394419> (2026-09-24) is confirmed public with full public-page QA, published as the second gap-funded extra task on the same America/Los_Angeles day and clearing catch-up gap 2026-09-01, alongside 40-mysql at <https://juejin.cn/post/7689030007914545198> (2026-09-24) is confirmed public with full public-page QA, published as a gap-funded extra task on the same America/Los_Angeles day as 41-xdp-tcpdump and clearing the earliest outstanding catch-up gap 2026-08-29, alongside 41-xdp-tcpdump at <https://juejin.cn/post/7688905828694294566> (2026-09-24), 45-scx-nest at <https://juejin.cn/post/7685561582916009994> (2026-09-15), 44-scx-simple at <https://juejin.cn/post/7686408837754142770> (2026-09-17), 43-kfuncs at <https://juejin.cn/post/7688489073967251494> (2026-09-22, review cleared 2026-09-23), and 42-xdp-loadbalancer at <https://juejin.cn/post/7688532185121947658> (2026-09-23), joining Runtime Security, 48-energy, 47-cuda-events, and 46-xdp-test | No known unresolved Juejin publication defect; the machine ledger maps 50/107 sources, with 57 unmatched and 28 open rolling-queue tasks, the next being 37-uprobe-rust; two documented catch-up gaps remain (2026-09-03, 2026-09-16) after the 2026-08-29 and 2026-09-01 gaps were redeemed by the 2026-09-24 40-mysql and 39-nginx publications | Monitor [author profile](https://juejin.cn/user/4288563097635144/posts); keep pre-staging the next queue artifact before its slot |
