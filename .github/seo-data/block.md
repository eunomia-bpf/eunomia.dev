...
no row for `2026-08-30`. Under the configured three-day finalization lag on
September 3, every row actually present in that six-day slice is finalized
evidence. Those six rows sum to **436 clicks and 55,594 impressions**, with
...
The GA4 organic landing-page aggregate for `2026-08-24..30` is now fully finalized
under the configured lag. It contains **1,007 sessions** at about **45.88%
session-weighted engagement**. The preceding finalized `2026-08-17..23` aggregate
contains 984 sessions at about 49.29% engagement. Sessions are about **2.3%
higher** week over week while engagement is about **3.41 percentage points
lower**.
