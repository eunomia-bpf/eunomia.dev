...
directly rechecked on `2026-08-31`; it still contains the source-native weekly
sets through `2026-08-17..23` and no newer weekly set was observed.

For Search Console, the verified latest date export remains through
...
configured three-day finalization lag and remains usable as a finalized
...
44.95% for `2026-08-10..16`. Sessions are about 1.4% higher and engagement about
4.34 percentage points higher. The weekly files have no date dimension, so they
