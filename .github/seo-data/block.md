...
directly rechecked on `2026-09-06`. No export newer than the source-native
`2026-08-24..30` weekly set is present; an explicit search for a set beginning
`2026-08-31` returned no result.
